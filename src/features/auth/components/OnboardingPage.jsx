    ...
    <div className="onboarding-shell">
      ...
      <div className="onboarding-container">
        ...
        <div className="onboarding-header">
          ...
          <p>
            Para comenzar a organizar tus tareas, necesitas pertenecer a un
            hogar.
          </p>
        </div>
        ...
        {view === "select" && (
          <div className="onboarding-cards">
            <div
              className="onboarding-card-option"
              onClick={() => {
                setView("create");
                setError("");
              }}
            >
              ...
              <p>
                Sé el administrador de tu hogar y crea un grupo para invitar a
                tu familia.
              </p>
            ...
            >
              ...
              <p>
                ¿Tus familiares ya crearon un hogar? Pídeles su código de
                invitación y únete.
              </p>
              <span className="action-indicator">
        ...
        {view === "join" && (
          <form className="onboarding-form" onSubmit={handleJoin}>
            <div className="form-title-group">
              ...
              <p>
                Ingresa el código de invitación de 8 caracteres provisto por tu
                familia.
              </p>
            </div>
